...
public class WebTablesPage {
	...
	public void navigateToWebTablesPage(WebDriver driver)
	{
	 ...
	 * @param dept
	 */
	public void addNewUserWithProvidedDetails(WebDriver driver, String fname, String lname, String email, String age, String salary, String dept)
	{
	...
	public void searchProvidedStringInSearchBox(WebDriver driver, String email)
	{
	...
	public boolean isProvidedUserWithEmailDisplayed(WebDriver driver, String email)
	{
		boolean flag = false;
		searchProvidedStringInSearchBox(driver, email);
		try {
	...
	public void editExistingUserWithProvidedDetails(WebDriver driver,String existingEmail, String fname, String lname, String email, String age, String salary, String dept)
	{
		searchProvidedStringInSearchBox(driver, existingEmail);
	...
	public void deleteUserWithProvidedEmailId(WebDriver driver, String email)
	{
		searchProvidedStringInSearchBox(driver, email);
	...
	public HashMap<String,String> getAllDetailsOfProvidedUser(WebDriver driver, String email)
	{
		searchProvidedStringInSearchBox(driver, email);
